...
},{"../utils.js":"utils.js"}],"classes/sidebar.js":[function(require,module,exports) {
"use strict";
...
var _block = require("./classes/block.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var text = "\n\xA9 <a href=\"https://t.me/herowamup\" target=\"_blank\">Herowarmup</a>\n";
var model = [new _block.TitleBlock("Конструктор сайтов на Vanilla JS", {
  tag: "h2",
  styles: {
  ...
  alt: "Это картинка"
}), new _block.ColumnsBlock(["Приложение на чистом JavaScript, без использования библиотек", "Учимся использовать принципы SOLID и ООП при разработке", "JavaScript - это просто, интересно. Научись создавать любые UI своими руками"], {
  styles: {
...
exports.model = model;
},{"./assets/image.png":"assets/image.png","./classes/block.js":"classes/block.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
